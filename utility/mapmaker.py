...
def make_floor(minimum_rooms=10, desired_dead_ends=5, size=20):
    ...
    # are not 0 (empty) or 1,2,4 or 8 (dead ends) and create a room adjacent to them
    # to increase the number of dead ends.
    avoid = [0, 1, 2, 4, 8]

    # Ensure we don't try to set values in positions that don't exist
